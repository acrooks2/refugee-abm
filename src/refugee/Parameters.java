...
class Parameters {
	 public static double TEMPORAL_RESOLUTION = 0.5;//steps per hour
	 ...
	 //-------Edge Weights-------//
	 public static double MAX_EDGE_LENGTH = 1337284.918;
	 public static double MIN_EDGE_LENGTH = 97403.99072;
	 ...
	 public static String ROAD_SHP = "data/shapefiles/roadsatt4.shp";//shapefile
	 public static String CITY_SHP = "data/shapefiles/cityatt8.shp";//have

...
class RoadInfo
{
    ...
    public RoadInfo(Geometry path, int from, int to, double speed, double distance,  double cost, double transportLevel, double deaths)
    {
   ...
   /* public void  addToPaths( Int2D node)
    {
        path.add(node);
    }*/
}
